...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_credential = Credentials("twitter","@youngkendrick","mwas")
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credential.username,"@youngkendrick")
        self.assertEqual(self.new_credential.pass_word,"mwas")
    ...
    def test_delete_credential(self):
        ...
        test_credential = Credentials("twitter","@youngkendrick","mwas")
    ...
    def test_find_user_by_account(self):
        ...
        self.new_credential.save_credential()
        test_credential = Credentials("twitter", "@manpsycho", "kiddoh") #new credential
        test_credential.save_credential()
